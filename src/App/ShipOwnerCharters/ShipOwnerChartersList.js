            ...
            <Table className={classes.table} size="small" aria-label="a dense table">
              ...
              {charters.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                  ...
                  <TableRow key={charter.id}>           
                     <TableCell align="right">{charter.ship.type}</TableCell>
                    <TableCell align="right">{charter.cargo.cargoType}</TableCell> 
                    <TableCell align="right">{charter.cargo.quantity}</TableCell>
                    <TableCell align="right">{charter.cargoUser.email}</TableCell>                   
                    ...
                    <TableCell align="right">{formatDate(charter.dateCreated)}</TableCell>
                    <TableCell align="right"> {numberFormat (charter.fixedFreight)}</TableCell>    
                    <TableCell align="right"> {charter.commission} %</TableCell>                                      
                  </TableRow>
                ))}
                <TableRow>
            <TableCell colSpan={7}><strong>Total Freight</strong></TableCell>
            <TableCell align="right">{numberFormat(invoiceSubtotal)}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell colSpan={7}><strong>Average Freight</strong></TableCell>
