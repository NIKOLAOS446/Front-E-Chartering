...
import ShipOwnerOffersList from './ShipOwnerOffersList'



class ShipOwnerOffers extends React.Component{
    constructor(props){
      super(props);
      this.state={
        offers: [],
            ...
            axios.put(`https://localhost:44321/api/ShipCargoRelations/` + offer.id, offer, config)
                .then(res => {                   
                    ...
                    if (index >= 0) {
                        ...
                        this.getofferslength(this.state.offers.length)
    ...
    export default ShipOwnerOffers